...
# Dev dependencies
assert_json "tailwindcss is a devDependency" "_.devDependencies && _.devDependencies.tailwindcss" "$PKG"
assert_json "@tailwindcss/postcss is a devDependency" "_.devDependencies && _.devDependencies['@tailwindcss/postcss']" "$PKG"
assert_json "postcss is a devDependency" "_.devDependencies && _.devDependencies.postcss" "$PKG"
assert_json "@types/react is a devDependency" "_.devDependencies && _.devDependencies['@types/react']" "$PKG"
assert_json "@types/react-dom is a devDependency" "_.devDependencies && _.devDependencies['@types/react-dom']" "$PKG"
assert_json "@types/node is a devDependency" "_.devDependencies && _.devDependencies['@types/node']" "$PKG"
